...
@app.route('/handled_example', methods=['GET'])
def example_endpoint():
    decipher_sdk.set_user({"id": "2958292", "email": "john@example.com", "name:": "John Smith"})
    // other code here
    return jsonify({"status": "success"}), 200
