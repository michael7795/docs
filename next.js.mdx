---
title: "Next.js (Server/Backend)"
description: "Decipher’s Next.js SDK for the backend allows for automatic capture of errors including helpful details like logs and raw payload data."
---

<Note> For frontend Next.js, see the [React](react) docs.</Note>
