...
Follow the [Uploading Sourcemaps](/sourcemaps) instructions, noting that for NextJS projects, they're usually in the .next/server directory.
...
## [Optional] Step 4: For apps using tRPC, add the tRPC Middleware.
