...
description: "Decipher’s Next.js SDK automatically captures frontend errors, session replays, AI analysis of user impact, and resolution steps. Decipher also automatically enhances stack traces with unminified/unbundled code (using Sourcemaps)."
mode: "wide"
---

<Check>⏱ Estimated Time To Completion: < 2 minutes</Check>
<Info>TypeScript is fully supported. Pure JavaScript projects will be supported soon.</Info>
